/* Array.prototype.map() is a way to iterate over each item in an array.
...
// Solution #1 using a for loop to pull the title and rating from watchList and save the new array in the rating variable  

for(var i=0; i < watchList.length; i++){
   rating1.push({title: watchList[i]["Title"],  rating: watchList[i]["imdbRating"]});
}

// Solution #2 replacing the loop functionality with the map expression
